...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    affiliateNoticeHidden: Schema.Attribute.Boolean;
    authors: Schema.Attribute.Relation<'oneToMany', 'api::author.author'>;
    category: Schema.Attribute.Relation<'oneToOne', 'api::category.category'>;
    content: Schema.Attribute.RichText;
    contentfulId: Schema.Attribute.String & Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    displayToc: Schema.Attribute.Boolean;
    listPriority: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::article.article'
    ...
    sponsoredArticle: Schema.Attribute.Boolean;
    teaserImage: Schema.Attribute.Media<'images' | 'files'>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    vgWortPixelUrl: Schema.Attribute.String;
  };
}
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    catIntroduction: Schema.Attribute.RichText;
    catIntroHead: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    main_menu: Schema.Attribute.Relation<'oneToMany', 'api::category.category'>;
    meta_description: Schema.Attribute.Text;
    meta_keywords: Schema.Attribute.String;
    meta_title: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    seo_text: Schema.Attribute.Blocks;
    teasers: Schema.Attribute.Relation<'oneToMany', 'api::teaser.teaser'>;
    title: Schema.Attribute.String;
    top_teaser: Schema.Attribute.Relation<'oneToOne', 'api::teaser.teaser'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiImageGalleryTagImageGalleryTag
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imageGalleries: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiImageGalleryImageGallery
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    serviceProvider: Schema.Attribute.RichText;
...
export interface ApiTeaserTeaser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    displayColorType: Schema.Attribute.Enumeration<
      ['light', 'dark', 'neutral']
    >;
    displayType: Schema.Attribute.Enumeration<
      [
        ...
        'fullimage_right',
        'fullimage_left',
        'article_imageright_half',
        'article_imageleft',
        'article_imageleft_half',
        'article_imageright',
      ]
    >;
